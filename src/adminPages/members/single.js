...
const SingleUser = (props) => {
  ...
  useEffect(() => {
    if (location?.state?.member === undefined) return push("/admin/members");
    document.title =
                                ...
                                <ul>
                                  {Object.values(
                                    ...
                                    if (distribute instanceof Object)
                                      return (
                                        <li key={i}>
                                          <span className="block hover:bg-gray-50 border-b  focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
